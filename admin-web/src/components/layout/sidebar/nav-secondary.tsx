...
import { ModalType, useModal } from "@/lib/stores/modal-store"
 ...
 * @param {string} props.items[].onclick - Optional modal type to open on click
 */
              ...
              <SidebarMenuButton asChild size="sm">
                {item.onclick === "userSettings" ? (
                  <button 
                    ...
                    onClick={() => onOpen((item.onclick || "userSettings") as ModalType)}
                  >
