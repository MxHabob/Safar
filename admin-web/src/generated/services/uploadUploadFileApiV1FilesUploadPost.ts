...
): Promise<z.infer<typeof UploadFileApiV1FilesUploadPostResponseSchema>> {
...
export function useUploadFileApiV1FilesUploadPostMutationUpload(options?: {
  onSuccess?: (data: z.infer<typeof UploadFileApiV1FilesUploadPostResponseSchema>) => void
  ...
  return useMutation<z.infer<typeof UploadFileApiV1FilesUploadPostResponseSchema>, Error, UploadFileApiV1FilesUploadPostUploadInput>({
    mutationFn: async ({ file, additionalFields, folder }: UploadFileApiV1FilesUploadPostUploadInput) => {
      ...
      return await uploadViaBackendApi(formData, options?.onProgress)
    },
    
    onSuccess: (data: z.infer<typeof UploadFileApiV1FilesUploadPostResponseSchema>) => {
