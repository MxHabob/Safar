  ...
  return (
    <Card className="overflow-hidden h-full flex flex-col">
      <div className="relative">
        <Image
          src={
            experience?.media && experience?.media.file[0]
              ? experience?.media.url[0]
  ...
  return (
    <Card className="overflow-hidden h-full flex flex-col">
      <div className="bg-sky-50 p-4 relative">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">{flight?.departure_time ? formatRelativeTime(flight?.departure_time) : "N/A"}</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">{flight?.arrival_time ? formatRelativeTime(flight?.arrival_time) : "N/A"}</div>
          </div>
        </div>
      </div>
      <CardContent className="flex-grow pt-4">
        <div className="flex justify-between items-center mb-2">
          <div className="text-sm">
            <span className="font-medium">Date:</span> {flight?.arrival_time ? formatRelativeTime(flight?.departure_time) : "N/A"}
          </div>
          <div className="text-sm">
