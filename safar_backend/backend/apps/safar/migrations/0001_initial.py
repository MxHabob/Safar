    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.JSONField(blank=True, default=list, null=True, verbose_name='Images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.ManyToManyField(blank=True, null=True, related_name='boxes', to='safar.experience', verbose_name='Experiences')),
            ],
            options={
                'verbose_name': 'Box',
        ...
        migrations.AddField(
            model_name='box',
            name='place',
            field=models.ManyToManyField(blank=True, null=True, related_name='boxes', to='safar.place', verbose_name='Places'),
        ),
        migrations.AddField(
            model_name='booking',
            name='place',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_type', models.CharField(db_index=True, max_length=50, verbose_name='Entity Type')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['entity_id', 'entity_type'], name='safar_image_entity__a8ae4d_idx')],
            },
        ),
        migrations.CreateModel(
            name='Message',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sender', 'receiver'], name='safar_messa_sender__df802c_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='place',
