# Generated by Django 5.1.7 on 2025-04-03 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', max_length=10, verbose_name='Currency')),
                ('contents', models.JSONField(blank=True, default=list, null=True, verbose_name='Contents')),
                ...
                ('experience', models.ManyToManyField(blank=True, related_name='boxes', to='safar.experience', verbose_name='Experiences')),
            ],
            options={
                'verbose_name': 'Box',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(db_index=True, default=False)),
                ('url', models.URLField(blank=True, null=True, verbose_name='Image URL')),
                ('file', models.ImageField(blank=True, null=True, upload_to=apps.safar.models.upload_file)),
                ('uploaded_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_images', to=settings.AUTH_USER_MODEL, verbose_name='Uploaded By')),
            ],
            options={
                'verbose_name': 'Image',
        ...
        migrations.AddField(
            ...
            name='images',
            field=models.ManyToManyField(blank=True, related_name='experiences', to='safar.image', verbose_name='Images'),
        ),
        migrations.AddField(
            model_name='box',
            name='images',
            field=models.ManyToManyField(blank=True, related_name='boxes', to='safar.image', verbose_name='Images'),
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(db_index=True, default=False)),
                ('type', models.CharField(choices=[('Booking Update', 'Booking Update'), ('Payment', 'Payment'), ('Discount', 'Discount'), ('Message', 'Message'), ('General', 'General')], db_index=True, default='General', max_length=50, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.city', verbose_name='City')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.country', verbose_name='Country')),
                ('images', models.ManyToManyField(blank=True, related_name='places', to='safar.image', verbose_name='Images')),
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.region', verbose_name='Region')),
            ],
            options={
                'verbose_name': 'Place',
        ...
        migrations.AddField(
            model_name='box',
            name='place',
            field=models.ManyToManyField(blank=True, related_name='boxes', to='safar.place', verbose_name='Places'),
        ),
        migrations.AddField(
            model_name='booking',
            name='place',
        ...
        migrations.AddIndex(
            model_name='image',
            index=models.Index(fields=['url', 'file'], name='safar_image_url_5cac62_idx'),
        ),
        migrations.AddIndex(
            model_name='message',
