...
export function useSearchListingsApiV1SearchListingsGet(
  ...
  return useQuery({
    queryKey: [...['searchListingsApiV1SearchListingsGet', query, city, country, listing_type, min_price, max_price, min_guests, min_bedrooms, min_bathrooms, latitude, longitude, radius_km, skip, limit], searchParams],
...
export function useInfiniteSearchListingsApiV1SearchListingsGet(
  ...
  return useInfiniteQuery({
    queryKey: [...['searchListingsApiV1SearchListingsGet', query, city, country, listing_type, min_price, max_price, min_guests, min_bedrooms, min_bathrooms, latitude, longitude, radius_km, skip, limit], 'infinite', searchParams],
    initialPageParam: 1,
...
export function useSuspenseSearchListingsApiV1SearchListingsGet(
  ...
  return useSuspenseQuery({
    queryKey: ['searchListingsApiV1SearchListingsGet', query, city, country, listing_type, min_price, max_price, min_guests, min_bedrooms, min_bathrooms, latitude, longitude, radius_km, skip, limit],
    queryFn: async () => {
      const result = await resolveActionResult<z.infer<typeof SearchListingsApiV1SearchListingsGetResponseSchema>>(searchListingsApiV1SearchListingsGet({ query: { query, city, country, listing_type, min_price, max_price, min_guests, min_bedrooms, min_bathrooms, latitude, longitude, radius_km, skip, limit } }))
      return result
    },
    staleTime: 30000,
    initialData: initialData as z.infer<typeof SearchListingsApiV1SearchListingsGetResponseSchema> | undefined,
